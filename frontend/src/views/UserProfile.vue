                    ...
                    <div class="col-md-6">
                        <div class="p-3 py-5">
                            ...
                            <div v-if="user.resume" class="row mt-3">
                                <div class="col-md-6">
                                    <a :href="user.resume">
                                        <img class="d-block float-end" src="http://localhost:8000/static/default_imgs/pdf_download.png" style="width:75px;height:75px;">
                                    </a>
                                </div>
                            ...
                            <div v-else class="row mt-3">
                                <div class="col-md-6">
                                   <img class="d-block float-end" src="http://localhost:8000/static/default_imgs/gray_pdf.png" style="width:75px;height:75px;">
                                </div>
                                <div class="col-md-6">
                                    <input @change="handleResumeUpload($event)" type="file" name="resume" class="form-control mt-3" accept="image/*" id="id_file">
                                </div>
