...
<div v-if="user">
  <div class="container rounded mt-5 mb-5">
    <form @submit.prevent="submit" enctype="multipart/form-data">
      <div class="row">
        <div class="col-md-4">
          <div v-if="user.avatar" class="d-flex flex-column align-items-center text-center p-3 py-5 mt-3">
            <img class="rounded-circle" :src="user.avatar" width="300" height="300" alt="avatar">
